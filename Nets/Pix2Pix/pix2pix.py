...
parser.add_argument("--epoch", type=int, default=59, help="epoch to start training from")
...
parser.add_argument(
    "--sample_interval", type=int, default=1500, help="interval between sampling of images from generators"
)
