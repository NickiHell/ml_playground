...
train_data = ImageFolder(root=f'{BASE_DIR}/Datasets/Classification/CatsDogs/training', transform=image_transforms)
valid_data = ImageFolder(root=f'{BASE_DIR}/Datasets/Classification/CatsDogs/validation', transform=image_transforms)
...
for epoch in range(opt.n_epochs):
    for i, ((imgs1, _), (imgs2, _)) in enumerate(zip(train_loader, valid_loader)):
